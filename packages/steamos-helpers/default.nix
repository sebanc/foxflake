...
if [ ! -z "''${GAMESCOPE_SESSION_WIDTH}" ] && [ ! -z "''${GAMESCOPE_SESSION_HEIGHT}" ] && [ ! -z "''${GAMESCOPE_SESSION_RERESH_RATE}" ]; then
        GAMESCOPE_FLAGS="''${GAMESCOPE_FLAGS} -w ''${GAMESCOPE_SESSION_WIDTH} -h ''${GAMESCOPE_SESSION_HEIGHT} -r ''${GAMESCOPE_SESSION_RERESH_RATE} -W ''${GAMESCOPE_SESSION_WIDTH} -H ''${GAMESCOPE_SESSION_HEIGHT}"
fi
